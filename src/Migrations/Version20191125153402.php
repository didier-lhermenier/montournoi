 ...
 */
final class Version20191125153402 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE `match` (id INT AUTO_INCREMENT NOT NULL, gamer1_id INT NOT NULL, gamer2_id INT NOT NULL, sport_id INT NOT NULL, pool_id INT DEFAULT NULL, score1 SMALLINT DEFAULT NULL, score2 SMALLINT DEFAULT NULL, round SMALLINT DEFAULT NULL, in_progress TINYINT(1) NOT NULL, INDEX IDX_7A5BC5052297DB63 (gamer1_id), INDEX IDX_7A5BC5053022748D (gamer2_id), INDEX IDX_7A5BC505AC78BCF8 (sport_id), INDEX IDX_7A5BC5057B3406DF (pool_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE `match` ADD CONSTRAINT FK_7A5BC5052297DB63 FOREIGN KEY (gamer1_id) REFERENCES gamer (id)');
        $this->addSql('ALTER TABLE `match` ADD CONSTRAINT FK_7A5BC5053022748D FOREIGN KEY (gamer2_id) REFERENCES gamer (id)');
        $this->addSql('ALTER TABLE `match` ADD CONSTRAINT FK_7A5BC505AC78BCF8 FOREIGN KEY (sport_id) REFERENCES sport (id)');
        $this->addSql('ALTER TABLE `match` ADD CONSTRAINT FK_7A5BC5057B3406DF FOREIGN KEY (pool_id) REFERENCES pool (id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE `match` DROP FOREIGN KEY FK_7A5BC5052297DB63');
        $this->addSql('ALTER TABLE `match` DROP FOREIGN KEY FK_7A5BC5053022748D');
        ...
        $this->addSql('ALTER TABLE `match` DROP FOREIGN KEY FK_7A5BC5057B3406DF');
